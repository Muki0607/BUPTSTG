...
---@return number x @转换后x坐标
---@return number y @转换后y坐标
...
---@return string text @删去文字效果后的文本
---@return string[] flag @文字效果类型
---@return string[] param @文字效果参数
---@return number[] el @文字效果起始位置
---@return number[] sr @文字效果终止位置
...
---@diagnostic disable: duplicate-type, duplicate-set-field
